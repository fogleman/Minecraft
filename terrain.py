...
class TerrainGeneratorSimple(TerrainGeneratorBase):
    ...
    def __init__(self, world, seed):
        ...
        self.water_level = 34 # have water 2 block higher than base, allowing for some rivers...
        ...
        self.world_type_grass = (YFlowers, Rose, Fern, Cactus, TallCactus)
        ...
        self.autogenerated_blocks = dict()
        for blocktype in (birchleaf_block, birchwood_block, oakleaf_block, oakwood_block, jungleleaf_block, junglewood_block, melon_block, pumpkin_block, yflowers_block, potato_block, carrot_block, rose_block):
            self.autogenerated_blocks[blocktype] = True
                    ...
                    if by < self.height_base:
                        ...
                        if y <= self.water_level:
                            ...
                            if G.TERRAIN_CHOICE == "desert":  #  no water for you!
                                ...
                                world_init_block((x, y -1, z), sand_block)
                                world_init_block((x, y -2, z), sandstone_block)
